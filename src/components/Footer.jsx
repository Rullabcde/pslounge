      ...
      <div className="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center">
          ...
          <p className="max-w-sm mx-auto mt-4 text-gray-500">
            Experience luxury and relaxation at PSLounge, where every detail is
            for your comfort.
          </p>
        ...
        <div className="pt-8 mt-16 border-t border-second sm:flex sm:items-center sm:justify-between lg:mt-24">
          <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
            <li>
              <Link
                to="hero"
                className="transition cursor-pointer text-second hover:opacity-75">
                {" "}
                Home{" "}
              </Link>
            </li>
          ...
          <ul className="flex justify-center gap-6 mt-8 sm:mt-0 lg:justify-end">
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="transition text-second hover:opacity-75">
